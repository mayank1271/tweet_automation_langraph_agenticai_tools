# ✅ SCRIPT 1: Tweet Fetcher (Selenium 4 Edge Version)
import os
import re
import time
import json
...
def get_driver(headless=False):
    edge_driver_path = r"C:\Users\mayank manjhi\Downloads\msedgedriver.exe"  # local driver

    options = Options()
    options.use_chromium = True  # Important! Enables Chromium-style options

    if headless:
        options.add_argument("--headless=new")  # Works with Chromium Edge

    # Chromium-style arguments
