...
def get_driver(headless=False):
    edge_driver_path = r"C:\WebDrivers\msedgedriver.exe"  # your local Edge driver

    options = Options()
    options.use_chromium = True   # ✅ Important! Without this, add_argument fails

    if headless:
        options.add_argument("--headless=new")

    # Chrome-like arguments
