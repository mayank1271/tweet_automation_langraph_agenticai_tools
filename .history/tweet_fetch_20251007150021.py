...
# === CONFIG ===
COOKIE_FILE = Path("x_cookies.json")  # Use this JSON for login
...
async def load_cookies(context):
    """Load cookies from x_cookies.json and convert expires to number."""
    if not COOKIE_FILE.exists():
        raise FileNotFoundError("❌ x_cookies.json not found.")
...
async def ensure_login(page):
    """Check login state via composer or home page."""
    try:
