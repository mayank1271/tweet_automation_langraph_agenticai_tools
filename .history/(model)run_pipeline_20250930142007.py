...
# Video file path
INPUT_VIDEO = r"C:\Users\mayank manjhi\Downloads\(1)lang,rag,ai\railways\videos\video48.mp4"
...
workflow.add_node("agent_actions", RunnableLambda(lambda state: app.ainvoke(state)))
